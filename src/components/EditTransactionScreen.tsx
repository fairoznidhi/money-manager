...
import { ChevronLeft, X, Plus, Trash2, Pencil } from "lucide-react";
import {
  Account,
  Category,
  Transaction,
      ...
      <div className="flex-1 overflow-y-auto px-4">
        ...
        <div className="py-6 flex gap-3">
          <button
            ...
            className="flex-1 py-3.5 rounded-xl border border-red-500/40 text-red-400 text-base font-bold flex items-center justify-center gap-2"
          >
          ...
          >
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                disabled={deleting}
                className="px-5 py-3 rounded-xl bg-red-500 text-white text-lg font-bold hover:bg-red-600 disabled:opacity-40"
              >
